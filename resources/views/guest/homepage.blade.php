                ...
                <a href="{{ route('guest.villa.detail', $villa->id) }}" style="text-decoration: none; color: inherit;">
                    <div class="villa-card">
                        <div class="villa-image">
                            @if ($villa->image_url)
                                <img src="{{ asset($villa->image_url) }}" alt="{{ $villa->name }}" style="width:100%; height:100%; object-fit: cover;">
                            @else
                                No image
                            @endif
                        </div>
    ...
    @if ($facilities && $facilities->count() > 0)
        <div class="facility-section" id="facility">
            ...
            <div class="facility-tabs">
                <div class="facility-tab active" onclick="filterFacility('all', this)">All</div>
                @php
                    $categories = $facilities->pluck('category')->unique();
                @endphp
                @foreach ($categories as $category)
                    <div class="facility-tab" onclick="filterFacility('{{ $category }}', this)">
